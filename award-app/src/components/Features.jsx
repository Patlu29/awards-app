    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
          🚀 Dive into a world of adventure, strategy, and stunning animations.
          Whether you're here to challenge yourself, explore new realms, or just
          have fun, it brings a seamless and visually captivating experience
